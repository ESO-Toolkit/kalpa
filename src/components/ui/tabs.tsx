...
const tabsListVariants = cva(
  "group/tabs-list relative inline-flex w-fit items-center justify-center rounded-xl p-1 text-muted-foreground group-data-horizontal/tabs:h-9 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default:
          "border border-structure-04 bg-structure-03 shadow-[inset_0_1px_2px_rgba(0,0,0,0.15)]",
...
function TabsIndicator({ className, ...props }: TabsPrimitive.Indicator.Props) {
  return (
    <TabsPrimitive.Indicator
      ...
      className={cn(
        "absolute rounded-lg bg-structure-08 border border-structure-04 shadow-[0_1px_3px_rgba(0,0,0,0.2),inset_0_1px_0_var(--structure-04)]",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-structure-08 data-active:text-white data-active:border-structure-04 data-active:shadow-[0_1px_3px_rgba(0,0,0,0.2),inset_0_1px_0_var(--structure-04)]",
