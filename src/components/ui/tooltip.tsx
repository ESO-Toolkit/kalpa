      ...
      >
        <TooltipPopup
          className={cn(
            ...
            "rounded-lg border border-structure-08 bg-surface-overlay px-3 py-1.5 shadow-[0_8px_32px_rgba(0,0,0,0.4),0_1px_0_var(--structure-06)_inset] backdrop-blur-xl backdrop-saturate-[1.3]",
