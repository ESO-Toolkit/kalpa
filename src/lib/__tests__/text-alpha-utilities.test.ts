...
const ALLOWLIST: Record<string, AllowlistReason> = {
  ...
  "src/components/appearance-settings.tsx|text-white/70": "icon-button",
  "src/components/backups.tsx|text-muted-foreground/60": "icon",
  "src/components/backups.tsx|text-white/20": "glyph",
  ...
  "src/components/update-banner.tsx|text-white/20": "aria-hidden",
