...
| W3 | in-review | `fix/audit-w3-worker-hardening` | [#379](https://github.com/ESO-Toolkit/kalpa/pull/379) (draft) | - | D-W3-1 reaccepted after reconsultation | Fresh REVISE; follow-up pending | Worker check; 233 tests; Wrangler dry-run | Stacked on refreshed W2/D-W2-2; fresh Sol bearer-fallback cache findings fixed and covered. No real deployment. |
