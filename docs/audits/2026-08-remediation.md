...
| W3 | in-progress | `fix/audit-w3-worker-hardening` | pending | - | D-W3-1 | REVISE twice; all verified findings addressed | Worker check; 218 tests; Wrangler dry-run | Stacked on W2; no real deployment. |
