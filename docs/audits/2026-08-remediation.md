...
|---|---|---|---|---|---|---|---|---|
| W1 | merged | `fix/audit-w1-worker-consistency` | [#369](https://github.com/ESO-Toolkit/kalpa/pull/369) | `16f76144125392832aa3428de220f3dd000807ed` | D-W1-1, D-W1-2, D-W1-3 | REVISE; follow-up REVISE; all verified findings addressed | Worker check; 184 tests; Wrangler dry-run; name guard | Merged to `main`; shadow-mode rollback and parity-gated authority-flip caveats remain operational follow-ups. |
