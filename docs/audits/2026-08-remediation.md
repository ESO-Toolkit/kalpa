...
| W3 | pr-open | `fix/audit-w3-worker-hardening` | [#379](https://github.com/ESO-Toolkit/kalpa/pull/379) (draft) | - | D-W3-1 | REVISE twice; all verified findings addressed | Worker check; 218 tests; Wrangler dry-run | Stacked on W2; no real deployment. |
| W3 | pr-open | `fix/audit-w3-worker-hardening` | [#379](https://github.com/ESO-Toolkit/kalpa/pull/379) (draft) | - | D-W3-1 | REVISE twice; all verified findings addressed | Worker check; 218 tests; Wrangler dry-run | Stacked on W2; no real deployment. |
