...
| W2 | blocked | `fix/audit-w2-d1-reconciliation` | [#378](https://github.com/ESO-Toolkit/kalpa/pull/378) (draft) | - | D-W2-1, D-W2-2 | Fresh Sol review pending after Fable revalidation | Worker check; 203 tests; Wrangler dry-run | Fable accepted the architecture with shadow-delete, D1-read-bound, and single-flight corrections. Stacked on W1; deletion/apply require maintainer approval. |
